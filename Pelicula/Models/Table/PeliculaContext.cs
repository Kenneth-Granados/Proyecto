...
namespace Pelicula.Models.Table
{
    public partial class PeliculaContext : DbContext
    {
        ...
        public virtual DbSet<Visualizacione> Visualizaciones { get; set; } = null!;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Visualizacione>(entity =>
            {
                entity.HasKey(e => e.IdVisualizaciones);
                ...
                entity.HasOne(d => d.IdPeliculaNavigation)
                    ...
                    .HasForeignKey(d => d.IdPelicula)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_Visualizaciones_PeliculaRepository");
            });
