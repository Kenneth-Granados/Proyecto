...
namespace Pelicula.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Compare("Password", ErrorMessage = "Confirma corectamente tu contraseña.")]
        ...
        {
            if (returnUrl == "/Identity/Account/Login")
            {
            ...
            if (ModelState.IsValid)
            {
                ...
                //// Seccion donde se mandan el correo de confirmacion

                await _context.Database.ExecuteSqlInterpolatedAsync
                    (
                        $@"EXECUTE SP_ConfirmarCuenta @Correo={Input.Email}, @User={Input.UserName}"
                    );
            ...
            {
                ModelState.AddModelError("1", returnUrl);
            }
